...
| `DUPLICATE_REFUND` | 409 | A full refund already exists, or `idempotency_key` has been seen |
...
| `INTERNAL_ERROR` | 500 | Unexpected server error — no details leaked to callers |
